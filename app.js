...
// === NATIVE BROWSER PRINT (FOR EDITABLE/SELECTABLE PDF) ===
  window.downloadRolePDF = async function(role) {
    // Membuka print dialog native dari browser.
    // CSS @media print akan secara otomatis menyembunyikan semua elemen selain panduan yang aktif.
    alert("Pastikan kamu memilih opsi 'Save as PDF' (Simpan sebagai PDF) pada menu tujuan pencetakan (Destination) untuk mendapatkan PDF yang bisa diedit teksnya.");
    window.print();
  };
